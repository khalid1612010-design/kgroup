document.addEventListener('DOMContentLoaded', () => {
  ...
  const PORTFOLIO_CATEGORIES = [
    { id: 'gifts', nameAr: 'هدايا', nameEn: 'Gifts' },
    { id: 'prints', nameAr: 'مطبوعات', nameEn: 'Prints' },
    { id: 'exhibition', nameAr: 'معرض', nameEn: 'Exhibition' }
  ];
  ...
  const translations = {
    ar: {
      ...
      'admin.servicesSubtitle': 'أضف صور الخدمات وحدد القسم المرتبط بها (هدايا، مطبوعات، ستندات).',
      ...
      'footer.copyright': '© 2026 kaizen. جميع الحقوق محفوظة.',
    ...
    en: {
      ...
      'admin.servicesSubtitle': 'Add service images and assign them to categories.',
      ...
      'footer.copyright': '© 2026 kaizen. All rights reserved.',
  ...
  const SERVICE_CATEGORIES = [
    ...
    { id: 'gifts', nameAr: 'الهدايا', nameEn: 'Gifts' },
    { id: 'stands', nameAr: 'الستندات', nameEn: 'Stands' }
  ];
  ...
  function renderServicesCategoryPills() {
    ...
    refs.servicesCategoryPills.querySelectorAll('[data-service-category]').forEach(button => {
      button.addEventListener('click', () => {
  ...
  function initializeRealtime() {
    ...
    state.realtimeChannel = supabaseClient
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'services_items' }, loadPublicCollections)
  ...
  function openPortfolioModal(portfolioId = null) {
    ...
    if (portfolioId) {
      ...
      const matchedCategory = PORTFOLIO_CATEGORIES.find(category => category.nameAr === item.titleAr || category.nameEn === item.titleEn);
